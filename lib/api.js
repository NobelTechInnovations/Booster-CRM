...
export async function sendWhatsAppMessage(conversationId, text, { mediaUrl, mediaType } = {}) {
...
export async function startWhatsAppConversation(to, text, { mediaUrl, mediaType } = {}) {
