...
export async function connectVelocity(payload) {
  return request("/api/channels/velocity/connect", {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify(payload),
  });
...
export async function createVelocityWarehouse(payload) {
  return request("/api/channels/velocity/warehouses", {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify(payload),
  });
...
export async function checkVelocityServiceability(payload) {
  return request("/api/channels/velocity/serviceability", {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify(payload),
  });
...
export async function createVelocityForwardOrder(payload) {
  return request("/api/channels/velocity/orders/forward", {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify(payload),
  });
...
export async function createVelocityReverseOrder(payload) {
  return request("/api/channels/velocity/orders/reverse", {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify(payload),
  });
...
export async function cancelVelocityOrder(awbs) {
  return request("/api/channels/velocity/orders/cancel", {
    method: "POST",
    headers: authHeaders(),
...
export async function trackVelocityOrder(awbs) {
  return request("/api/channels/velocity/orders/track", {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify({ awbs }),
  });
...
export async function getVelocityReports(payload) {
  return request("/api/channels/velocity/reports", {
    method: "POST",
    headers: authHeaders(),
    body: JSON.stringify(payload),
  });
...
export async function listVelocityShipments() {
  return request("/api/channels/velocity/shipments", {
    headers: authHeaders(),
  });
}
